...
import { Pill, Plus, Clock, CheckCircle2, AlertTriangle, Calendar as CalendarIcon, Loader2, Activity, ArrowRight, Zap, Edit2, Trash2 } from 'lucide-react';
                ...
                {lowStockMeds.map(med => (
                  <div key={med.id} className="p-5 rounded-xl bg-orange-50 border border-orange-100 group hover:shadow-lg hover:shadow-orange-500/10 transition-all">
                    ...
                    <Button 
                      variant="primary" 
                      size="sm" 
                      className="mt-4 w-full h-10 rounded-xl bg-orange-500 hover:bg-orange-600 text-white border-none font-bold text-xs"
                      onClick={async () => {
                        try {
